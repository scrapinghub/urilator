...
-export([suffix/1, domain/1, is_tld/1]).

%% This is autogenerated by script from
%% http://mxr.mozilla.org/mozilla-central/source/netwerk/dns/effective_tld_names.dat?raw=1


-spec is_tld(undefined|string()) -> boolean().
is_tld(undefined) -> true;
is_tld(Domain) when is_list(Domain) ->
    case publicsuffix:suffix(Domain) of
        undefined -> true;
        Domain -> true;
        _ -> false
    end.
...
suffix(Domain) ->
	case lists:reverse(string:tokens(Domain, ".")) of
        [First | Rest] -> parts(First, Rest);
        [] -> undefined
    end.
